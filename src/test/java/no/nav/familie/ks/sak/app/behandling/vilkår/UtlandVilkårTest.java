...
import no.nav.familie.ks.sak.app.behandling.vilkår.utland.UtlandVilkår;
...
public class UtlandVilkårTest {
    ...
    public void søknad_med_tilknytning_utland_gir_ikke_oppfylt() {
        ...
        Faktagrunnlag faktagrunnlag = FaktagrunnlagBuilder.familieUtenlandskStatsborgerskapMedTilknytningUtland();
