...
public class PeriodeInfo {
    ...
    public static class Builder {
        ...
        public Builder medPeriodeStatusÅrsak(PeriodeStatusÅrsak periodeStatusÅrsak) {
            periodeInfo.periodeStatusÅrsak = periodeStatusÅrsak;
            return this;
        }
        ...
        public Builder medGjelderMedlemskapIFolketrygden(boolean gjelderMedlemskapIFolketrygden) {
            periodeInfo.gjelderMedlemskapIFolketrygden = gjelderMedlemskapIFolketrygden;
            return this;
        }
