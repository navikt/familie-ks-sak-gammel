...
import no.nav.familie.ks.sak.app.behandling.regel.mvp.annenPart.regel.AnnenPartErOppgitt;
...
public class AnnenPartErOppgittVilkår implements InngangsvilkårRegel<Faktagrunnlag> {

    @Override
    public VilkårType getVilkårType() {
        return VilkårType.ANNEN_PART_ER_OPPGITT;
    }
    ...
    public Specification<Faktagrunnlag> getSpecification() {
        ...
        return rs.hvisRegel(AnnenPartErOppgitt.ID, "Vurder om annen part finnes i grunnlaget fra TPS (MVP)")
            .hvis(new AnnenPartErOppgitt(), Sluttpunkt.oppfylt())
            .ellers(Sluttpunkt.ikkeOppfylt(VilkårIkkeOppfyltÅrsak.ANNEN_PART_ER_IKKE_OPPGITT));
    }
}
