...
public enum VilkårType {
    ...
    MEDLEMSKAPBOSTED(Constants.MEDLEMSKAPBOSTED_KODE, "Medlemskap til folketrygden", "§2 og §3"),
    MEDLEMSKAPMEDL(Constants.MEDLEMSKAPMEDL_KODE, "Medlemskap til folketrygden", "§2 og §3"),
    MEDLEMSKAPSTATSBORGERSKAP(Constants.MEDLEMSKAPSTATSBORGERSKAP_KODE, "Medlemskap til folketrygden", "§2 og §3"),
    ...
    public static class Constants {
        public static final String MEDLEMSKAPBOSTED_KODE = "MEDL";
        public static final String MEDLEMSKAPMEDL_KODE = "MEDL";
        public static final String MEDLEMSKAPSTATSBORGERSKAP_KODE = "MEDL";
