...
public enum VilkårType implements VilkårEllerAvvikType {
    ...
    BARN_BOR_MED_FORELDRE(Constants.BOSTED_KODE, "Kontantstøtte ytes til den som barnet bor fast hos.", "§3"),
    BARN_NORSK_STATSBORGER(Constants.BARN_KODE, "Barn er norsk statsborger", "§2"),
    ...
    public static class Constants {
        ...
        public static final String MEDLEMSKAP_STATSBORGERSKAP_KODE = "MEDL4";
